...
export default function CreateChaptersPage() {
  ...
  const handleGenerateVideo = async (videoId: string) => {
    ...
    // In real app, this would trigger HeyGen API
  };
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {selectedVideos.size > 0 && (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-violet-500 to-purple-600 text-white font-medium rounded-xl hover:from-violet-600 hover:to-purple-700 disabled:opacity-50 transition-all"
            >
              {isGenerating ? (
                <>
      ...
      <div className="bg-white rounded-xl p-4 border border-gray-200 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Trained and ready to generate videos</p>
          </div>
        </div>
        <a
